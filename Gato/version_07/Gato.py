...
Versión 0.7:
Se agregó la música y los efectos del sonido al juego.
"""
...
def run_game() -> None:
    ...
    while not game_over:
        ...
        game_over = game_events(marks_group, turn_image, audio)
        ...
        # Si el juego terminó, mostrar pantalla y sonido de resultados.
        if game_over:
            game_over_screen(screen, clock, background, marks_group, turn_image, result, audio)
            break

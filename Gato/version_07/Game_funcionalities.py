...
def game_events(marks_group, turn_image:TurnImage, audio:Audio):
    """
...
def game_over_screen(screen:pygame.surface.Surface, clock: pygame.time.Clock, background: Background, marks_group:pygame.sprite.Group, turn_image: TurnImage, result, audio:Audio) -> None:
    """
    ...
    while time.time() - start_time < 5:  # Mostrar por 5 segundos
        # Hora actual
